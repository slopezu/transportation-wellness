...
export default function Footer() {
  ...
  return (
    <footer className="bg-white dark:bg-black text-black dark:text-white py-4 border-t border-stroke dark:border-stroke-dark" data-testid="main-footer">
      <div className="container mx-auto px-6 max-w-[1400px]">
        <div className="flex flex-col items-center justify-center space-y-4">
          <div className="flex space-x-4">
            ...
            <a href="https://maps.app.goo.gl/9Ej64a9Xz7NqY5ui9" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200">
