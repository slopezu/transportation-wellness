...
const workProcessData = [
  {
    ...
    description: "We will meet you at the airport or your chosen location, ready to start your journey.",
  },
  {
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-12 h-12">
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mt-16 max-w-3xl mx-auto">
          <p className="text-lg mb-6 text-gray-700">
            ...
            we will be waiting for you right outside the main exit, holding a sign with your name, 
            ready to start your journey. If your pick-up location is elsewhere—such as a hotel, 
            Airbnb, house, Hospital or any other spot you choose—we will be there on time, happy and ready 
            to begin your ride.
          </p>
